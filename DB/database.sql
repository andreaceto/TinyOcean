CREATE DATABASE  IF NOT EXISTS `tinyocean` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `tinyocean`;
...
CREATE TABLE `acquario` (
  ...
  CONSTRAINT `articolo_acq` FOREIGN KEY (`articolo`) REFERENCES `articolo` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `acquario`
--

LOCK TABLES `acquario` WRITE;
/*!40000 ALTER TABLE `acquario` DISABLE KEYS */;
/*!40000 ALTER TABLE `acquario` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `allestimento`
--

LOCK TABLES `allestimento` WRITE;
/*!40000 ALTER TABLE `allestimento` DISABLE KEYS */;
/*!40000 ALTER TABLE `allestimento` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `contenuto` (
  ...
  `prezzoAcquisto` decimal(5,2) NOT NULL DEFAULT '0.00',
  `iva` int DEFAULT NULL,
  `quantita` int NOT NULL,
  PRIMARY KEY (`numOrdine`,`articolo`),
  KEY `articolo_contenuto_idx` (`articolo`),
  CONSTRAINT `articolo_contenuto` FOREIGN KEY (`articolo`) REFERENCES `articolo` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `numOrdine` FOREIGN KEY (`numOrdine`) REFERENCES `ordine` (`numOrdine`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `decorazione` (
  ...
  CONSTRAINT `articolo_dec` FOREIGN KEY (`articolo`) REFERENCES `articolo` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fatturazione` (
  ...
  CONSTRAINT `metodoPagamento` FOREIGN KEY (`numCarta`) REFERENCES `metodo_pagamento` (`numCarta`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `utente_fatturazione` FOREIGN KEY (`utente`) REFERENCES `utente` (`username`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fondo` (
  ...
  CONSTRAINT `tipo_fondo` FOREIGN KEY (`decorazione`, `tipo`) REFERENCES `decorazione` (`articolo`, `tipo`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `foto` (
  ...
  CONSTRAINT `articolo_foto` FOREIGN KEY (`articolo`) REFERENCES `articolo` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `illuminazione` (
  ...
  PRIMARY KEY (`decorazione`,`tipo`),
  CONSTRAINT `tipo_illuminazione` FOREIGN KEY (`decorazione`, `tipo`) REFERENCES `decorazione` (`articolo`, `tipo`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `illuminazione`
--

LOCK TABLES `illuminazione` WRITE;
/*!40000 ALTER TABLE `illuminazione` DISABLE KEYS */;
/*!40000 ALTER TABLE `illuminazione` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `indirizzo` (
  ...
  CONSTRAINT `indirizzoSpedizione` FOREIGN KEY (`via`, `numCivico`, `cap`) REFERENCES `indirizzo_spedizione` (`via`, `numCivico`, `cap`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `utente_indirizzo` FOREIGN KEY (`utente`) REFERENCES `utente` (`username`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mangime` (
  ...
  PRIMARY KEY (`articolo`),
  CONSTRAINT `articolo_mang` FOREIGN KEY (`articolo`) REFERENCES `articolo` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mangime`
--

LOCK TABLES `mangime` WRITE;
/*!40000 ALTER TABLE `mangime` DISABLE KEYS */;
/*!40000 ALTER TABLE `mangime` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `manutenzione` (
  ...
  PRIMARY KEY (`articolo`),
  CONSTRAINT `articolo_manut` FOREIGN KEY (`articolo`) REFERENCES `articolo` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ordine` (
  ...
  CONSTRAINT `utente_ordine` FOREIGN KEY (`utente`) REFERENCES `utente` (`username`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pianta` (
  ...
  PRIMARY KEY (`decorazione`,`tipo`),
  CONSTRAINT `tipo_pianta` FOREIGN KEY (`decorazione`, `tipo`) REFERENCES `decorazione` (`articolo`, `tipo`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `pianta` WRITE;
/*!40000 ALTER TABLE `pianta` DISABLE KEYS */;
/*!40000 ALTER TABLE `pianta` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `recensione` (
  ...
  CONSTRAINT `articolo_recensione` FOREIGN KEY (`articolo`) REFERENCES `articolo` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `utente_recensione` FOREIGN KEY (`utente`) REFERENCES `utente` (`username`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-04-26 21:53:33
